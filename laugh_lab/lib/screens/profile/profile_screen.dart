...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  void initState() {
    super.initState();
    // Initialize user stats with default values to prevent null issues
    _userStats = {'totalJokes': 0, 'totalUpvotes': 0, 'totalRemixes': 0};
      ...
      body: SafeArea(
        child: FutureBuilder<UserModel?>(
          ...
          builder: (context, snapshot) {
            ...
            if (_userStats['totalJokes'] == 0 && _userStats['totalUpvotes'] == 0) {
              _loadUserStats();
            }
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    if (_userData!.preferredCategories.isNotEmpty) ...[
                      ...
                      Center(
                        child: Wrap(
                          ...
                          children: _userData!.preferredCategories.map((category) {
                            return Container(
                    ...
                    // Add padding at the bottom to ensure content isn't hidden behind nav bar
